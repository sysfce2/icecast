...
#define SOURCE_FLAG_NOT_UTF_8           ((source_flags_t)0x00001000U)

#define SOURCE_FLAGS_CLEARABLE          (SOURCE_FLAG_LEGACY_METADATA|SOURCE_FLAG_HTTP_1_0_LISTENER|SOURCE_FLAG_NOHOST_LISTENER|SOURCE_FLAG_NOT_UTF_8)
